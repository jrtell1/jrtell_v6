    ...
    <nav class="container mx-auto flex items-center justify-between py-6 px-4">
      ...
      <div class="flex flex-grow items-center">
        <div class="flex-grow flex justify-end">
          <nuxt-link to="/" class="block sm:hidden px-4 py-2 whitespace-no-wrap">Home</nuxt-link>
          <nuxt-link to="/projects" class="block px-4 py-2 whitespace-no-wrap">Projects</nuxt-link>
          <nuxt-link to="/work-history" class="block px-4 py-2 whitespace-no-wrap">Work history</nuxt-link>
          <nuxt-link to="/proficiencies" class="block px-4 py-2 whitespace-no-wrap">Proficiencies</nuxt-link>
